import { 
    ...
    Cloud, 
    TrajectoryPoint 
} from '../../../../shared/types/artillery-duel';

export class ArtilleryGame {
    private gameId: string;
    private roomId: string;
    private players: Map<string, ArtilleryPlayer>;
    private terrain: number[];
    private vegetation: VegetationItem[];
    ...
    private playerActivity: { [key: string]: { lastActivity: number; isActive: boolean } };
    private gameStatus: 'waiting' | 'active' | 'finished';
    private currentShotId: string | null = null;
    private processedShotIds: Set<string> = new Set();
    private waitingForTurnEnd: boolean = false;

    constructor(gameId: string, roomId: string, difficulty: 'easy' | 'medium' | 'hard' = 'medium') {
        this.gameId = gameId;
        this.roomId = roomId;
    ...
    getGameState(): ArtilleryGameState {
    ...
    applyDamage(playerId: string, damage: number): boolean {
    ...
    setWaitingForTurnEnd(waiting: boolean): void {
        this.waitingForTurnEnd = waiting;
    }

    isWaitingForTurnEnd(): boolean {
    ...
    addProcessedShotId(shotId: string): void {
        this.processedShotIds.add(shotId);
    }

    hasProcessedShot(shotId: string): boolean {
