...
const goose_duel_1 = require("../../../../shared/types/goose-duel");
class GooseGame {
    constructor(gameId, boardLength = 50) {
        this.gameId = gameId;
        this.players = new Map();
        this.boardLength = boardLength;
        this.board = (0, goose_duel_1.generateBoard)(boardLength);
        this.placedTraps = [];
    ...
    createDeck() {
        ...
        for (let i = 0; i < 40; i++) {
            ...
            deck.push({ id: `card-${cardId++}`, ...goose_duel_1.GOOSE_CARDS[cardKey] });
        }
